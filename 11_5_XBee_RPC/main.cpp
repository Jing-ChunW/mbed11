...
void ldld(Arguments *in, Reply *out);
...
int main(){
   ...
   xbee.write("ATMY 0x263\r\n", 12);
   reply_messange(xbee_reply, "setting MY : 0x263");
   xbee.write("ATDL 0x163\r\n", 12);
   reply_messange(xbee_reply, "setting DL : 0x163");
